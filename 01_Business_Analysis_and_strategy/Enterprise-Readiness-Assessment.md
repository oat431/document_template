---
document_type: Enterprise Readiness Assessment
schema_version: 2
canonical_name: Enterprise Readiness Assessment
doc_form: heavy
...
tags: [readiness-assessment, change-management, organizational-readiness, babok]
standard_ref:
...
```mermaid
flowchart LR
    A[Awareness<br>X% aware] --> D[Desire<br>X% willing]
    D --> K[Knowledge<br>X% trained]
    K --> AB[Ability<br>X% proficient]
    AB --> R[Reinforcement<br>X% sustained]
...
radar-beta
    ...
    axis Org["Organizational"], Cultural["Cultural"], Tech["Technical"], People["People"], Process["Process"], Resource["Resource"]
    curve Current["Current State"]{3.5, 2.8, 4.2, 3.0, 3.8, 4.0}
    curve Target["Target (Go-Live)"]{4.0, 4.0, 4.5, 4.0, 4.0, 4.5}
```
