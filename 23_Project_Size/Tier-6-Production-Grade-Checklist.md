---
document_type: Project Tier Checklist — Tier 6 Production Grade
schema_version: 2
canonical_name: Tier 6 Production Grade Checklist
doc_form: record
...
tags: [tier-checklist, tier-6, project-size, generated]
generator: Generated from template frontmatter — do not hand-edit; regenerate instead
---

# 🟣 Tier 6 — Production Grade — Document Checklist

> **Description:** Full rigor — high-stakes SaaS, enterprise product, or large user base.
> **Team:** 5+ devs | **Users:** 100K+ users | **Lifespan:** Long-term
> **Tier source:** `checklist/release-checklist/release.md` §Project Tier Scoping Matrix
>
> **Key principle:** Everything a Tier-6 project needs = every template with `min_project_tier ≤ 6` whose trigger applies. Anything above tier 6 is over-engineering for this context.
>
> **Scope:** 343 artifacts (21 new at this tier, 322 inherited from lower tiers).
...
| [[Risk-Report]] | 🟡 | record | T5 | Produced by the activity it records | ☐ |
...
| [[Gantt-Chart-Schedule]] | 🔴 | light | T5 | always | ☐ |
...
| [[Modification-Request]] | 🔴 | light | T5 | always | ☐ |
...
| [[RCA-Reports]] | 🟡 | record | T5 | Formal QA program or certification context | ☐ |
