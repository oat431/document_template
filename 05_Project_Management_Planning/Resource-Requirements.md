...
schema_version: 2
canonical_name: Resource Requirements
doc_form: light
...
### 2.1 [Deliverable Area] ([WBS ID])

| WBS | Activity | Role | Quantity | Duration | Skills | Start | End |
|-----|----------|------|----------|----------|--------|-------|-----|
| [X.X.X] | [Activity] | [Role] | [N] ([X]%) | [X days] | [Skills] | [Date] | [Date] |

> **Repeat this table for each WBS deliverable area.**
...
|----------|-----------|-------------|--------|
| [Role] | [X days] | [X]% | [Status note] |

## 4. Resource Constraints

| # | Constraint | Impact | Mitigation |
|---|-----------|--------|-----------|
| 1 | [Constraint] | [Impact] | [Mitigation] |
