...
schema_version: 2
canonical_name: Software Requirements Specification
doc_form: heavy
...
source_of_truth: 04_Requirements_Engineering/Software-Requirements-Specification.md
overlap_note: Software-level (SRS) — distinct scope
version: "1.0"
status: Draft
author: "[Author Name]"
created: "[YYYY-MM-DD]"
